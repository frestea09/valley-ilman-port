...
export const AboutUsSection = () => {
  ...
  return (
    <div className="hidden lg:flex flex-col gap-9 px-52 max-h-[1900px] justify-center items-center">
      ...
      <button
        className="text-[#910A67] w-[300px] rounded-md hover:text-white hover:bg-[#910A67] font-semibold py-3"
